                    ...
                    <div class="row">
                        <div class="col-8">
                            <div class="toggle-switch">
                                <input type="checkbox" class="toggle-input" id="includeViewCheck">
                                <label class="toggle-label" for="includeViewCheck"></label>
                                <span class="form-check-label">Include View Routes</span>
                            </div>
                            <div class="toggle-switch">
                                <input type="checkbox" class="toggle-input" id="generateNewFileCheck">
                        ...
                        <div class="col-4 text-center">
                            <button type="button" class="export-btn">Export All Routes</button>
                            <button type="button" class="export-btn">Export Definitions</button>
